    ...
    <main class="col-lg-9">
        <div class="bg-sj-gradient p-4 p-md-5 text-white mb-5 position-relative overflow-hidden">
            <div class="position-relative" style="z-index: 2;">
                ...
                <p class="lead opacity-90">Negocio de tradición en Misantla, Veracruz. Selecciona una categoría para armar tu pedido.</p>
            ...
            <div class="card-body p-4">
                <div class="row g-3 align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="text-muted mb-0">Dirección: Calle Melchor Ocampo SN, Colonia Centro, Misantla, Veracruz, CP 93821.</p>
                    </div>
