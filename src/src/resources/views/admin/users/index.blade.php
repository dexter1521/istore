        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('admin.users.reset-password', $user) }}" method="POST" class="d-inline" data-confirm="Resetear password y generar uno temporal?">
                        @csrf
                        <button type="submit" class="btn btn-sm btn-outline-warning">Reset</button>
                    </form>
                    <form action="{{ route('admin.users.destroy', $user) }}" method="POST" class="d-inline" data-confirm="Eliminar este usuario?">
                        @csrf
                        @method('DELETE')
